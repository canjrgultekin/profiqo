// Path: apps/admin/src/app/api/integrations/hepsiburada/connection/route.ts
...
export async function GET() {
  ...
  const upstream = await fetch(`${backendBaseUrl()}/api/integrations/hepsiburada/connection`, {
    method: "GET",
