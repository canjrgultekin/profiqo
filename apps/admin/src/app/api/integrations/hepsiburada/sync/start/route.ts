// Path: apps/admin/src/app/api/integrations/hepsiburada/sync/start/route.ts
...
export async function POST(req: Request) {
  ...
  const upstream = await fetch(`${backendBaseUrl()}/api/integrations/hepsiburada/sync/start`, {
    method: "POST",
    headers: {
