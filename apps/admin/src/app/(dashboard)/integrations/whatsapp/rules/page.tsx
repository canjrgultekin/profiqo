// Path: apps/admin/src/app/(dashboard)/integrations/whatsapp/rules/page.tsx
"use client";
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-stroke bg-white p-5 shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
          <div className="mb-4 flex items-center justify-between">
            ...
            <span className={`rounded-full px-2.5 py-0.5 text-xs font-medium ${editId ? "bg-yellow-light-4 text-yellow-dark-2 dark:bg-yellow-dark/10 dark:text-yellow-light" : "bg-primary/10 text-primary"}`}>
              {editId ? "Editing" : "New"}
            </span>
          </div>
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`rounded-full px-2 py-0.5 text-[10px] font-semibold ${r.mode === 1 ? "bg-primary/10 text-primary" : "bg-blue-light-5 text-blue-600 dark:bg-blue/10 dark:text-blue-light"}`}>
                    ...
                    <span className={`flex-shrink-0 rounded-full px-2 py-0.5 text-[10px] font-semibold ${r.isActive ? "bg-green-light-7 text-green-dark dark:bg-green/10 dark:text-green-light" : "bg-gray-2 text-dark-5 dark:bg-dark-3 dark:text-dark-6"}`}>
