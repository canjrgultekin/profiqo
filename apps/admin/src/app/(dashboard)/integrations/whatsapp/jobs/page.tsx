// Path: apps/admin/src/app/(dashboard)/integrations/whatsapp/jobs/page.tsx
"use client";
    ...
    <div className="p-4 sm:p-6">
      ...
      {err && (
        <div className="mb-4 flex items-center gap-2 rounded-xl border border-red-200 bg-red-50 px-4 py-3 dark:border-red-900/30 dark:bg-red-900/10">
          ...
          <span className="text-sm text-red-600 dark:text-red-light">{err}</span>
        </div>
      )}
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                {selectedRule?.dailyLimit === 2 && !template2Id && (
                  <div className="mt-1.5 rounded-md bg-yellow-50 px-2.5 py-1.5 text-xs text-yellow-dark-2 dark:bg-yellow-900/10 dark:text-yellow-light">
                  ...
                  <div className="max-h-40 space-y-1.5 overflow-y-auto">
                    {targets.map((t) => (
                      <div key={t.customerId} className="flex items-center justify-between rounded-md bg-green-50/50 px-3 py-2 dark:bg-green-900/5">
                        ...
                        <button onClick={() => removeTarget(t.customerId)} className="rounded-md bg-red-50 px-2 py-1 text-[10px] font-medium text-red-500 hover:bg-red-light-5 dark:bg-red-900/10 dark:hover:bg-red/10">✕</button>
                      </div>
                    ))}
                  </div>
                )}
                ...
                <div key={j.id} className={`rounded-lg border p-4 ${j.isActive ? "border-green-200 bg-green-50/50 dark:border-green-900/20 dark:bg-green-900/5" : "border-stroke dark:border-dark-3"}`}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`rounded-full px-2 py-0.5 text-[10px] font-semibold ${j.isActive ? "bg-green-light-7 text-green-dark dark:bg-green/10 dark:text-green-light" : "bg-gray-2 text-dark-5 dark:bg-dark-3 dark:text-dark-6"}`}>
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    ...
                    <button onClick={() => setActive(j.id, !j.isActive)} className={`rounded-md px-3 py-1.5 text-xs font-medium ${j.isActive ? "border border-yellow-300 text-yellow-dark-2 hover:bg-yellow-50 dark:border-yellow-900/30 dark:text-yellow-light" : "border border-green-300 text-green-dark hover:bg-green-50 dark:border-green-900/30 dark:text-green-light"}`}>
