// Path: apps/admin/src/app/(dashboard)/automation/sync-rules/page.tsx
"use client";
...
export default function SyncRulesPage() {
  ...
  return (
    <div className="space-y-6">
      <Breadcrumb pageName="Senkronizasyon Kuralları" />
                  ...
                  <div
                    className={`mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg ${
                      r.status === "active"
                        ...
                        : "bg-gray-3 text-dark-5 dark:bg-dark-3"
                    }`}
                  >
                    <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      ...
                      <span
                        className={`inline-flex rounded-full px-2 py-0.5 text-xs font-medium ${
                          r.status === "active"
                            ...
                            : "bg-gray-3 text-dark-4 dark:bg-dark-3 dark:text-dark-6"
                        }`}
                      >
