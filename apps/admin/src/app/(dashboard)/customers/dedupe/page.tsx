// Path: apps/admin/src/app/(dashboard)/customers/dedupe/page.tsx
"use client";
...
function ConfidenceBadge({ value }: { value: number }) {
  ...
  const color = pct >= 90 ? "bg-green-light-7 text-green-dark dark:bg-green/10 dark:text-green-light" : pct >= 70 ? "bg-yellow-light-4 text-yellow-dark-2 dark:bg-yellow-dark/10 dark:text-yellow-light" : "bg-red-light-5 text-red-dark dark:bg-red/10 dark:text-red-light";
...
export default function CustomerDedupePage() {
  ...
  return (
    <div className="space-y-6">
      <Breadcrumb pageName="Müşteri Kimlik Analizi" />
      ...
      {analyzing && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl dark:bg-gray-dark">
            ...
            <div className="mt-4 h-2 w-full overflow-hidden rounded-full bg-gray-3 dark:bg-dark-3">
      ...
      <div className="rounded-xl border border-stroke bg-white p-6 shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        {error && (
          <div className="mt-4 flex items-center gap-2 rounded-lg border border-red-200 bg-red-50 px-4 py-3 dark:border-red-900/30 dark:bg-red-900/10">
            ...
            <span className="text-sm text-red-600 dark:text-red-light">{error}</span>
          </div>
        )}
        {info && (
          <div className="mt-4 flex items-center gap-2 rounded-lg border border-green-200 bg-green-50 px-4 py-3 dark:border-green-900/30 dark:bg-green-900/10">
            ...
            <span className="text-sm text-green-600 dark:text-green-light">{info}</span>
          </div>
        )}
      </div>
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-stroke bg-white p-6 shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
          <div className="mb-4 flex items-baseline justify-between">
            ...
            <span className="rounded-full bg-gray-2 px-2.5 py-0.5 text-xs font-semibold text-dark-5 dark:bg-dark-3 dark:text-dark-6">{pending.length} grup</span>
          </div>
              ...
              {pending.map((g) => (
                <div key={g.groupKey} className="rounded-lg border border-stroke p-4 dark:border-dark-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="rounded-full bg-gray-2 px-2 py-0.5 text-[10px] font-semibold text-dark-5 dark:bg-dark-3 dark:text-dark-6">{g.count} kayıt</span>
                  </div>
