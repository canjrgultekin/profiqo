  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        datepicker: "-5px 0 0 #1a2744, 5px 0 0 #1a2744",
        1: "0px 1px 2px 0px rgba(11, 143, 216, 0.08)",
        2: "0px 2px 3px 0px rgba(11, 143, 216, 0.10)",
        3: "0px 8px 16px 0px rgba(11, 143, 216, 0.04), 0px 8px 16px 0px rgba(11, 143, 216, 0.06), 0px 18px 31px 0px rgba(11, 143, 216, 0.08)",
        4: "0px 13px 40px 0px rgba(13, 10, 44, 0.22), 0px -8px 18px 0px rgba(13, 10, 44, 0.04)",
        5: "0px 10px 30px 0px rgba(11, 143, 216, 0.10), 0px 4px 10px 0px rgba(11, 143, 216, 0.04), 0px -18px 38px 0px rgba(11, 143, 216, 0.03)",
        6: "0px 12px 34px 0px rgba(13, 10, 44, 0.08), 0px 34px 26px 0px rgba(13, 10, 44, 0.05)",
        7: "0px 18px 25px 0px rgba(11, 143, 216, 0.04)",
      },
      dropShadow: {
