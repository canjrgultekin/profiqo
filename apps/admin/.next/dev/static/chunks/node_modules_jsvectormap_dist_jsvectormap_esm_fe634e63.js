...
"[project]/node_modules/jsvectormap/dist/jsvectormap.esm.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ var Line = /*#__PURE__*/ function(_BaseComponent) {
    function Line(_ref) {
        var _this;
        var index = _ref.index, map = _ref.map, style = _ref.style, x1 = _ref.x1, y1 = _ref.y1, x2 = _ref.x2, y2 = _ref.y2, group = _ref.group, config = _ref.config;
        _this = _BaseComponent.call(this) || this;
        _this.config = config;
 ...
 */ var Marker = /*#__PURE__*/ function(_BaseComponent) {
    function Marker(_ref) {
        var _this;
        var index = _ref.index, style = _ref.style, label = _ref.label, cx = _ref.cx, cy = _ref.cy, map = _ref.map, group = _ref.group;
        _this = _BaseComponent.call(this) || this;
        // Private
        _this._map = map;
    ...
    _proto._createLabel = function _createLabel(_ref2) {
        var index = _ref2.index, map = _ref2.map, label = _ref2.label, labelsGroup = _ref2.labelsGroup, cx = _ref2.cx, cy = _ref2.cy, marker = _ref2.marker, isRecentlyCreated = _ref2.isRecentlyCreated;
...
function getInsetForPoint(x, y) {
    ...
    for(var index = 0; index < insets.length; index++){
        var _insets$index$bbox = insets[index].bbox, start = _insets$index$bbox[0], end = _insets$index$bbox[1];
...
//# sourceMappingURL=node_modules_jsvectormap_dist_jsvectormap_esm_fe634e63.js.map