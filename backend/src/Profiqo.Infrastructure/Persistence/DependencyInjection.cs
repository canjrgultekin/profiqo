...
using Profiqo.Infrastructure.Integrations.Hepsiburada;
using Profiqo.Infrastructure.Integrations.Shopify;
...
public static class DependencyInjection
{
    public static IServiceCollection AddProfiqoPersistence(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        // ── Hepsiburada ─────────────────────────────────────────
        services.Configure<HepsiburadaOptions>(configuration.GetSection("Profiqo:Integrations:Hepsiburada"));
        services.AddHttpClient<IHepsiburadaClient, HepsiburadaClient>();
        services.AddScoped<IHepsiburadaSyncStore, HepsiburadaSyncStore>();
        services.AddScoped<IHepsiburadaSyncProcessor, HepsiburadaSyncProcessor>();


        // ── Shopify ─────────────────────────────────────────────
        services.Configure<ShopifyOptions>(configuration.GetSection("Profiqo:Integrations:Shopify"));
        services.AddHttpClient<IShopifyTokenService, ShopifyTokenService>();
        services.AddHttpClient<IShopifyGraphqlClient, ShopifyGraphqlClient>();
        services.AddScoped<IShopifySyncStore, ShopifySyncStore>();
        services.AddScoped<IShopifySyncProcessor, ShopifySyncProcessor>();
