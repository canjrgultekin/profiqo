...
namespace Profiqo.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260126203704_V0002__integration_jobs")]
    partial class V0002__integration_jobs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Profiqo.Infrastructure.Persistence.Entities.IntegrationJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_integration_jobs");

                    b.HasIndex("BatchId")
                        .HasDatabaseName("ix_integration_jobs_batch_id");

                    b.HasIndex("Status", "CreatedAtUtc")
                        .HasDatabaseName("ix_integration_jobs_status_created_at_utc");

                    b.HasIndex("TenantId", "ConnectionId")
                        .HasDatabaseName("ix_integration_jobs_tenant_id_connection_id");

                    b.ToTable("integration_jobs", (string)null);
                });
